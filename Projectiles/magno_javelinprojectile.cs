...
{
    public class magno_javelinprojectile : ModProjectile
    {
        /// <summary>
        /// Code from the ExampleMod javelin projectile.
        /// 
        /// I seemed to find no other way of doing what this code 
        /// does efficiently, therefore this is either lasting
        /// or a placeholder until I simply replicate this method.
        /// </summary>
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int item =
                Main.rand.Next(18) == 0
                    ? Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<magno_javelin>())
                    : 0;
...
//DOT buff  target.AddBuff(mod.BuffType<Buffs.ExampleJavelin>(), 900); // Adds the ExampleJavelin debuff for a very small DoT
