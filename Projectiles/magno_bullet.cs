    ...
    class magno_bullet : ModProjectile
    {
        ...
        //  Main.projectileTexture[projectile.type] = mod.GetTexture("NPCs/m_flame");
            ...
            if (Main.rand.NextFloat() >= .80f)
            {
                ...
                proj1 = Projectile.NewProjectile(position, projectile.velocity, 207, 20 + Main.rand.Next(0, 10), 2f, projectile.owner, 0f, 0f);
                proj2 = Projectile.NewProjectile(position, projectile.velocity, 207, 20 + Main.rand.Next(0, 10), 2f, projectile.owner, 0f, 0f);
            }
        }
